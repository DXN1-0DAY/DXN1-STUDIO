...
![version](https://img.shields.io/badge/version-3.0.84-8b5cf6?style=flat-square)
...
| `:changes [n]` | the census — a bare verb lists the session's touched lines; a number leaps to the Nth |
...
| `:s/old/new` | replace every exact old with new on the selection's lines — one undo step |
| `:sa/old/new` | the whole document is the bed — the swap's other face |
