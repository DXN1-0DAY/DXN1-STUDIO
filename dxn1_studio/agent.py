...
class PromptPreviewDialog(tk.Toplevel):
    ...
    def __init__(self, app, text):
        ...
        # DS2 v2.63 — width accounting round five: the v2.60 inline
        # heal joins the one shared pattern — once the build settles,
        # open no narrower (or shorter) than what it actually packed
        # (the 680x520 default is the floor)
