...
└── … 81 feature modules, one lane each, described below
```

## Design rules (what keeps 81 modules coherent)
...
| `scripts/smoke_v290.py` (Xvfb) | 141 live-window checks across 23 feature windows |
