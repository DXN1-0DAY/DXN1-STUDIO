...
└── … 78 feature modules, one lane each, described below
```

## Design rules (what keeps 78 modules coherent)
...
| `scripts/smoke_v290.py` (Xvfb) | 126 live-window checks across 20 feature windows |
