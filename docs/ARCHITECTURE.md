...
└── … 80 feature modules, one lane each, described below
```

## Design rules (what keeps 80 modules coherent)
...
| `scripts/smoke_v290.py` (Xvfb) | 136 live-window checks across 22 feature windows |
